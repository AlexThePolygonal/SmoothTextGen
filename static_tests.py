...
base_model = AutoModelForCausalLM.from_pretrained("roneneldan/TinyStories-33M").to(
    device
) #.double()
...
# male_toks = [
#     tokenizer.encode(word, return_tensors="pt").to(device)
#     for word in [
#         "He",
#         "he",
#         "His",
...
#     return (
#         remove_token_loss(toks, tokprobs, male_toks)
#         - remove_token_loss(toks, tokprobs, female_toks)
#         - llm_ratio(toks[:, :, 0])
#     )
...
set_determininsm(42)
base_tokens = tokenizer.encode("One ", return_tensors="pt").to(device)
a, b = model.generate_double(base_tokens, 20)
print(a.tokprobs - b.tokprobs)
